    ...
    <div id="wrapper" class="clearfix">
        ...
        <section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('<?= base_url() ?>/files/web-assets/paralax.png'); padding: 120px 0;" data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -300px;">
            <div class="container clearfix">
                <h1 class="mt-3 mb-0">Klinik Putri</h1>
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-9 col-md-12 col-12">
                            <div class="card bottommargin">
                                <div class="card-body">Klinik Pelayanan Publik Terintegrasi <strong>(Klinik PUTRI)</strong></div>
                            </div>
                            <div class="row">
                                <div class="col-xl-8 col-lg-8 col-md-12 col-12 mb-3">
                                    <img src="<?= base_url() ?>/files/web-assets/klinik-putri.jpeg" width="100%" alt="">
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-12 col-12">
                                    <div class="card border-0 shadow-sm">
                                        <div class="card-body">
                                            <h5 class="mb-0"><i class="icon-angle-double-right text-muted"></i> JUKNIS KLINIK PUTRI</h5>
                                            <a class="ms-3 mt-2" target="_BLANK" href="<?= base_url() ?>/files/doc/juknis_klinik_putri.pdf"><i class="icon-file-alt1"></i> Dokumen Juknis</a>
                                        </div>
                                    </div>
                                    <div class="card border-0 shadow-sm mt-3">
                                        <div class="card-body">
                                            <h5 class="mb-0"><i class="icon-angle-double-right text-muted"></i> SOP KLINIK PUTRI</h5>
                                            <a class="ms-3 mt-2" target="_BLANK" href="<?= base_url() ?>/files/doc/sop_klinik_putri.pdf"><i class="icon-file-alt1"></i> Dokumen SOP</a>
                                        </div>
                                    </div>
                                    <div class="card border-0 shadow-sm mt-3">
                                        <div class="card-body">
                                            <h5 class="mb-0"><i class="icon-angle-double-right text-muted"></i> KONTAK LAYANAN</h5>
                                            <span class="ms-3">0822-6161-6841</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
