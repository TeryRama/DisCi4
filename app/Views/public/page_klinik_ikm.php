    ...
    <div id="wrapper" class="clearfix">
        ...
        <section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('<?= base_url() ?>/files/web-assets/paralax.png'); padding: 120px 0;" data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -300px;">
            <div class="container clearfix">
                <h1 class="mt-3 mb-0">Klinik IKM</h1>
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-9 col-md-12 col-12">
                            <div class="card bottommargin">
                                <div class="card-body">Klinik IKM</div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-12 col-12">
                                    <div class="card border-0 shadow-sm">
                                        <div class="card-body">
                                            <h5 class="mb-0"><i class="icon-angle-double-right text-muted"></i> JUKNIS KLINIK IKM</h5>
                                    ...
                                    <div class="card border-0 shadow-sm mt-3">
                                        <div class="card-body">
                                            <h5 class="mb-0"><i class="icon-angle-double-right text-muted"></i> SOP KLINIK IKM</h5>
