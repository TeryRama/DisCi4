	...
	<div id="wrapper" class="clearfix">
		...
		<section id="slider" class="slider-element h-auto" style="background-color: #222;">
			<div class="slider-inner">
				...
				<div class="owl-carousel carousel-widget" data-margin="0" data-items="1" data-pagi="true" data-loop="true" data-animate-in="fadeIn" data-speed="5000" data-animate-out="fadeOut" data-autoplay="5000">
					<a href="#"><img src="<?= base_url() ?>/files/web-assets/banner.jpg" alt=""></a>
					<a href="#"><img src="<?= base_url() ?>/files/web-assets/banner2.jpg" alt="CSR Bengkalis"></a>
				</div>
		...
		<section id="content">
			<div class="content-wrap py-0">
				<div style="background-color: #2c7e58;">
					<div class="container clearfix">
						<div class="row">
							<div class="col-lg-3">
								<img src="<?= base_url() ?>/files/web-assets/kadis.png" width="100%" alt="">
							</div>
							<div class="col-lg-9 mt-3">
								<h3 class="text-white mt-3">SEKAPUR SIRIH</h3>
						...
						<div class="d-flex flex-column align-items-center justify-content-center center counter-section position-relative">
							<div class="row align-items-stretch m-0 w-100 clearfix">
								<div class="col-lg-3 col-sm-6 center mt-5">
									...
									<div class="counter font-secondary"><span data-from="0" data-to="10" data-refresh-interval="50" data-speed="2200" data-comma="true"></span>+</div>
									<h5 class="nott ls0 mt-0">Total Pasar yang Dipantau</h5>
								</div>

								<div class="col-lg-3 col-sm-6 center mt-5">
									<div class="counter font-secondary"><span data-from="0" data-to="13" data-refresh-interval="25" data-speed="2300" data-comma="true"></span>+</div>
