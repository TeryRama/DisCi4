...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                    ...
                    <div class="d-flex flex-column-fluid">
                        <div class="container">
                            <div class="card card-custom">
                                ...
                                <div class="card-body">
                                    <div class="mb-7">
                                        <form action="<?= base_url() ?>/admin/laporan/barang-penting-lainnya" method="GET">
                                            <div class="row">
                                                        ...
                                                        <?php if (isset($_GET['tahun']) && isset($_GET['bulan']) && count($tanggal) > 0) { ?>
                                                            <div class="ml-4 dropdown">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                    <a href="<?= base_url('/crud/laporan/komoditas-lainnya?bulan=' . $_GET['bulan'] . '&tahun=' . $_GET['tahun'] . '&act=pdf') ?>" class="dropdown-item">PDF</a>
    ...
    <script>
        ...
        function exportExcel() {
            ...
            table2excel.export(document.querySelectorAll("#isiData"), "Laporan Perkembangan Harga Komoditas Barang Penting Lainnya");
        }
    </script>
</body>
