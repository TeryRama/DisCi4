                            ...
                            <div class="card card-custom">
                                <div class="card-header">
                                    ...
                                    <div class="card-toolbar">
                                        <a href="<?= base_url('/root/artikel/tambah') ?>" class="btn btn-fh btn btn-light-primary btn-hover-primary font-weight-bold px-2 px-lg-5 mr-2">
                                                    ...
                                                    <td>
                                                        <div class="dropdown dropdown-inline mr-4">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="<?= base_url('/root/artikel/edit/' . encrypt_url($row->artikel_id)) ?>">Edit Details</a>
