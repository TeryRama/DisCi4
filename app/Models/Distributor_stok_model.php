...
class Distributor_stok_model extends Model
{
    protected $table = 'tb_distributor_stok';
    protected $primaryKey = 'distributor_id';

    function get_distributor_by_filter($item, $keyword)
    {
        $query = $this->db
            ->table('tb_distributor_stok')
            ->select('distributor_id, distributor_nama, distributor_toko, distributor_alamat, distributor_kontak')
