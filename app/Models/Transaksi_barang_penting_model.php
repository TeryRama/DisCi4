...
class Transaksi_barang_penting_model extends Model
{
    protected $table = 'tb_transaksi_penting';
    protected $primaryKey = 'transaksi_id';

    public function get_transaksi_by_distributor_barang_date($distributor, $barang, $date)
    {
        return $this->db
            ->table('tb_transaksi_penting')
    ...
    public function get_all_transaksi_by_filter($limit, $awal, $akhir, $keyword)
    {
        $query = $this->db
            ...
            ->join('tb_barang_penting', 'tb_transaksi_penting.transaksi_barang = tb_barang_penting.barang_id')
            ->join('tb_distributor_barang_penting', 'tb_transaksi_penting.transaksi_distributor = tb_distributor_barang_penting.distributor_id')
