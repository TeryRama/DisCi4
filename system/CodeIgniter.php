...
class CodeIgniter
{
    ...
    public function run(?RouteCollectionInterface $routes = null, bool $returnResponse = false)
    {
        if ($this->context === null) {
            throw new LogicException('Context must be set before run() is called. If you are upgrading from 4.1.x, you need to merge `index.php` and `spark` file from `vendor/codeigniter4/framework`.');
        }
     ...
     *  3. PHP CLI: accessed by CLI via php index.php, arguments become URI segments,
