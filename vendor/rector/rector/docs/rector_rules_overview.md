...
Non-magic PHP object methods cannot start with "\_\_"
...
Downgrade ReflectionClass->getConstants(ReflectionClassConstant::IS\_\*)
...
Adds namespace to namespace-less files or correct namespace to match PSR-4 in `composer.json` autoload section. Run with combination with "Rector\PSR4\Rector\Namespace\_\MultipleClassFileToPsr4ClassesRector"
...
Changes rand, srand and getrandmax by new mt\_\* alternatives.
...
Add type to property by added rules, mostly property by parent type
